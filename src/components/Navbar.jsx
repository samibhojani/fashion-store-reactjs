    ...
    <>
        <header className='w-full fixed z-10'>
            <section>
                ...
                <div className='flex flex-row justify-between p-5 md:px-32 px-5 bg-PrimaryColor shadow-[rgba(0,0,0,0.24)_0px_3px_8px]'>
                    <div>
                        <Link
                            to='home'
                            spy={true}
                            ...
                            duration={500}
                        >
                        <h1 className='text-2xl font-semibold text-ExtraDarkColor cursor-pointer'>StyleRetailer.</h1>
                        </Link>
                    </div>
                ...
                <div className='flex items-center gap-5'>
                    ...
                    <FaShoppingCart size={25}  />                   
                        <div className='absolute top-[-17px] right-[-10px] bg-red-600 w-[25px] h-[20px] rounded-full text-white text-sm grid place-items-center'>
                            0
                        </div>                        
